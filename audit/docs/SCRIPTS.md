...
| 2 | `review_gt_artifacts.py` with `review_gt_artifacts.html` | Simple playback, confirmed whole-frame artifact separation, automatic resume and final partition export |
